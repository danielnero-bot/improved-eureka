        ...
        <main className="py-10 px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto">
            ...
            <header className="mb-12 text-center">
              <h1 className="text-4xl md:text-5xl font-bold text-[#111714] dark:text-gray-100">
            ...
            <section className="space-y-12">
              ...
              <article>
                ...
                <p className="text-[#111714] dark:text-gray-300 mb-4">
            ...
            <section className="mt-16 text-center border-t border-gray-200 dark:border-gray-700 pt-12">
              ...
              <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-4">
                <button className="h-12 px-6 rounded-lg bg-primary text-[#111714] font-bold hover:scale-105 transition-transform">
                  Go to Dashboard
                </button>
                <button className="h-12 px-6 rounded-lg border border-[#111714] dark:border-gray-300 text-[#111714] dark:text-gray-200 font-bold hover:bg-gray-100 dark:hover:bg-gray-800 transition-all">
                  View Restaurants
                </button>
              </div>
            </section>
